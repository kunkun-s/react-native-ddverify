...
public class RNDdverifyPackage extends BaseReactPackage {
    @Nullable
    @Override
    public NativeModule getModule(String name, @NonNull ReactApplicationContext reactContext) {
        if (name.equals(RNDdverifyImpl.NAME)) {
            /**
             ...
             */
            return new RNDdverifyModule(reactContext);
        } else {
            return null;
        }
    }
    ...
    public ReactModuleInfoProvider getReactModuleInfoProvider() {
        return new ReactModuleInfoProvider() {
            ...
            public Map<String, ReactModuleInfo> getReactModuleInfos() {
                ...
                map.put(RNDdverifyImpl.NAME, new ReactModuleInfo(
                        RNDdverifyImpl.NAME,       // name
                        RNDdverifyImpl.NAME,       // className
